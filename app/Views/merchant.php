          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h4 class="card-title">Laporan Transaksi Merchant</h4>
                </div>
                <div class="card-body">
                    <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
          type : 'GET',
          url : window.location.origin+'/api/allmerchant',
          headers:{
          ...
          success:function(data){
            ...
            for (const i in data){
              html += ""+
              "<option value="+data[i].id+">"+data[i].merchant_name+"</option>";
            }
            $('#merchant_id').html(html);
          }
        });
        ...
        $('body').on('click','#btn-submit',function(){
          ...
          var url = window.location.origin+'/api/merchantapi?tanggal-awal='+tanggal_awal+'&tanggal-akhir='+tanggal_akhir+'&merchant_id='+merchant;
